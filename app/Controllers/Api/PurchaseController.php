...
{
    protected $modelName = PurchaseModel::class;
    protected array $hashFields = [];

    public function index(): ResponseInterface
    {
        /** @var PurchaseModel $model */
        $model = model(PurchaseModel::class);
        $limit  = (int) ($this->request->getGet('limit') ?? 100);
        $offset = (int) ($this->request->getGet('offset') ?? 0);
        $limit  = max(1, min($limit, 500));
        $offset = max(0, $offset);

        return $this->ok($model->findAllSafe($limit, $offset), 'Purchase list');
    }
    ...
    public function show($id = null): ResponseInterface
    {
        ...
        if ($row === null) {
            return $this->failNotFoundMessage('Purchase not found');
        }

        return $this->ok($row, 'Purchase detail');
    }
    ...
    public function create(): ResponseInterface
    {
        ...
        return $this->ok($model->findSafe($id), 'Purchase created', 201);
    }
    ...
    public function update($id = null): ResponseInterface
    {
        ...
        return $this->ok($model->findSafe($id), 'Purchase updated');
    }
    ...
    public function delete($id = null): ResponseInterface
    {
        ...
        return $this->ok(null, 'Purchase deleted');
    }
}