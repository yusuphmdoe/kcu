...
class UnitController extends BaseApiController
{
    ...
    public function index(): ResponseInterface
    {
        ...
        return $this->ok($model->findAllSafe($limit, $offset), 'Unit list');
    }
    ...
    public function show($id = null): ResponseInterface
    {
        ...
        if ($row === null) {
            return $this->failNotFoundMessage('Unit not found');
        }

        return $this->ok($row, 'Unit detail');
    }
    ...
    public function create(): ResponseInterface
    {
        ...
        return $this->ok($model->findSafe($id), 'Unit created', 201);
    }
    ...
    public function update($id = null): ResponseInterface
    {
        ...
        return $this->ok($model->findSafe($id), 'Unit updated');
    }
