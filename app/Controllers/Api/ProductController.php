...
class ProductController extends BaseApiController
{
    ...
    public function index(): ResponseInterface
    {
        ...
        return $this->ok($model->findAllSafe($limit, $offset), 'Product list');
    }
    ...
    public function show($id = null): ResponseInterface
    {
        ...
        if ($row === null) {
            return $this->failNotFoundMessage('Product not found');
        }

        return $this->ok($row, 'Product detail');
    }
    ...
    public function create(): ResponseInterface
    {
        ...
        return $this->ok($model->findSafe($id), 'Product created', 201);
    }
    ...
    public function update($id = null): ResponseInterface
    {
        ...
        return $this->ok($model->findSafe($id), 'Product updated');
    }
