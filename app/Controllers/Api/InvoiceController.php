...
class InvoiceController extends BaseApiController
{
    ...
    public function index(): ResponseInterface
    {
        ...
        return $this->ok($model->findAllSafe($limit, $offset), 'Invoice list');
    }
    ...
    public function show($id = null): ResponseInterface
    {
        ...
        if ($row === null) {
            return $this->failNotFoundMessage('Invoice not found');
        }

        return $this->ok($row, 'Invoice detail');
    }
    ...
    public function create(): ResponseInterface
    {
        ...
        return $this->ok($model->findSafe($id), 'Invoice created', 201);
    }
    ...
    public function update($id = null): ResponseInterface
    {
        ...
        return $this->ok($model->findSafe($id), 'Invoice updated');
    }
